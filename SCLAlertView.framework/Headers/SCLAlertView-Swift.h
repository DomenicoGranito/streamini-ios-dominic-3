...
- (SCLButton * _Nonnull)addButton:(NSString * _Nonnull)title backgroundColor:(UIColor * _Nullable)backgroundColor textColor:(UIColor * _Nullable)textColor showDurationStatus:(BOOL)showDurationStatus target:(id _Nonnull)target selector:(SEL _Null_unspecified)selector;
