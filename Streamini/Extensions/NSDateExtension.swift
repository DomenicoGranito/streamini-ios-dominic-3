...
func NSDateTimeAgoLocalizedStrings(key: String) -> String {
    ...
    let path = NSString(string: resourcePath!).stringByAppendingPathComponent("NSDateTimeAgo.bundle")
...
extension NSDate {
    ...
    func lessThan24Hours(date: NSDate) -> Bool {
        let distanceBetweenDates = NSDate().timeIntervalSinceDate(date)
