...
public class ARNVTransitionAnimator: UIPercentDrivenInteractiveTransition {
    ...
    public var direction : ARNVTransitionAnimatorDirection = .Bottom
    public var contentScrollView : UIScrollView?
    public var interactiveType : ARNVTransitionAnimatorOperation = .None {
        didSet {
    ...
    private(set) var operationType : ARNVTransitionAnimatorOperation
